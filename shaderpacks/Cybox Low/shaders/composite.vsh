...
void main() {
	moonlight = ivec3(30,50,80)/255.0/100.0;
...
ambient_color = mix(sky_color, nsunlight,10-exp(-0.16*tL*(1-rainStrength*0.8)))*tL*sunVisibility*(1-rainStrength*0.8) + tLMoon*moonVisibility*moonlight;
