...
const int shadowMapResolution = 512;		//Shadows resolution. [512 1024 2048 3072 4096 8192]
const float shadowDistance = 60;			//Draw distance of shadows.[60 90 120 150 180 210]
